...
exports.tasksRouter
    ...
    .post(tasks_validator_1.createValidator, tasks_controller_1.taskController.create)
    .put(tasks_validator_1.updateValidator, tasks_controller_1.taskController.update);
